...
<%
    ...
    try {
        ...
        System.err.println("Error en borrar.jsp (NumberFormatException): " + e.getMessage());
        e.printStackTrace();
    } catch (IllegalArgumentException e) {
        error = "Error: " + e.getMessage();
        System.err.println("Error en borrar.jsp (IllegalArgumentException): " + e.getMessage());
        e.printStackTrace();
    } catch (Exception e) {
        error = "Error al intentar eliminar el programador: " + e.getMessage();
        System.err.println("Error en borrar.jsp (General Exception): " + e.getMessage());
        e.printStackTrace();
    }
